...
fastify.register(Promise.resolve().then(() => __importStar(require('./routes/waste'))), { prefix: '/api/v1' });
...
fastify.register(Promise.resolve().then(() => __importStar(require('./routes/sales'))), { prefix: '/api/v1' }); // Enable POS Sales
