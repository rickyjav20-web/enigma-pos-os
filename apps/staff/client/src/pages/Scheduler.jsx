...
export default function Scheduler() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const [empRes, schRes] = await Promise.all([
                ...
                axios.get(`/api/schedules?start=${start.toISOString()}&end=${end.toISOString()}`, config)
            ]);
    ...
    const handleAutoFill = async () => {
        ...
        try {
            ...
            await axios.post('/api/schedules/autofill', {
    ...
    const handleDelete = async (id, e) => {
        ...
        try {
            await axios.delete(`/api/schedules/${id}`, { headers: { 'x-tenant-id': 'enigma-cafe' } });
            fetchData();
